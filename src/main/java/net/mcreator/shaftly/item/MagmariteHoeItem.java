...
public class MagmariteHoeItem extends ShaftlyModElements.ModElement {
	@ObjectHolder("shaftly:magmarite_hoe")
	public static final Item block = null;
	public MagmariteHoeItem(ShaftlyModElements instance) {
		super(instance, 28);
	}
