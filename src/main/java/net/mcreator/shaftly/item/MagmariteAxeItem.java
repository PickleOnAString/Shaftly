...
public class MagmariteAxeItem extends ShaftlyModElements.ModElement {
	@ObjectHolder("shaftly:magmarite_axe")
	public static final Item block = null;
	public MagmariteAxeItem(ShaftlyModElements instance) {
		super(instance, 25);
	}
